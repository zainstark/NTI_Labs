module controller_test;
  ...
  initial begin
    ...
    $write(" 0"); phase=0; #1 expected (9'b100000000); // sel
    $write(" 1"); phase=1; #1 expected (9'b110000000); // sel, rd
    $write(" 2"); phase=2; #1 expected (9'b111000000); // sel, rd, ld_ir
    $write(" 3"); phase=3; #1 expected (9'b111000000); // sel, rd, ld_ir
    $write(" 4"); phase=4; #1 expected (9'b000110000); // inc_pc, halt
    $write(" 5"); phase=5; #1 expected (9'b000000000); //
    $write(" 6"); phase=6; #1 expected (9'b000000000); //
    $write(" 7"); phase=7; #1 expected (9'b000000000); //
    $write("\n");
    ...
    $write(" 2"); phase=2; #1 expected (9'b111000000); // sel, rd, ld_ir
    $write(" 3"); phase=3; #1 expected (9'b111000000); // sel, rd, ld_ir
    $write(" 4"); phase=4; #1 expected (9'b000100000); // inc_pc
    $write(" 5"); phase=5; #1 expected (9'b000000000); //
    $write(" 6"); phase=6; #1 expected (9'b000000000); //
                  zero=1;  #1 expected (9'b000100000); // inc_pc
    $write(" 7"); phase=7; #1 expected (9'b000000000); //
    $write("\n");
    ...
    $write(" 3"); phase=3; #1 expected (9'b111000000); // sel, rd, ld_ir
    $write(" 4"); phase=4; #1 expected (9'b000100000); // inc_pc
    $write(" 5"); phase=5; #1 expected (9'b010000000); // rd
    $write(" 6"); phase=6; #1 expected (9'b010000000); // rd
    $write(" 7"); phase=7; #1 expected (9'b010000010); // rd, ld_ac
    $write("\n");
    ...
    $write(" 4"); phase=4; #1 expected (9'b000100000); // inc_pc
    $write(" 5"); phase=5; #1 expected (9'b000000000); //
    $write(" 6"); phase=6; #1 expected (9'b000000100); // data_e
    $write(" 7"); phase=7; #1 expected (9'b000000101); // data_e, wr
    $write("\n");
    ...
    $write(" 4"); phase=4; #1 expected (9'b000100000); // inc_pc
    $write(" 5"); phase=5; #1 expected (9'b000000000); //
    $write(" 6"); phase=6; #1 expected (9'b000001000); // ld_pc
    $write(" 7"); phase=7; #1 expected (9'b000001000); // ld_pc
