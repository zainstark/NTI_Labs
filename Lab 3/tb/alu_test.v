module alu_test;
  ...
  initial begin
    opcode=PASS0; in_a=8'h42; in_b=8'h86; #1 expected (1'b0, 8'h42);
    opcode=PASS1; in_a=8'h42; in_b=8'h86; #1 expected (1'b0, 8'h42);
    ...
    opcode=PASS6; in_a=8'h42; in_b=8'h86; #1 expected (1'b0, 8'h42);
    opcode=PASS7; in_a=8'h42; in_b=8'h86; #1 expected (1'b0, 8'h42);
    opcode=PASS7; in_a=8'h00; in_b=8'h86; #1 expected (1'b1, 8'h00);
    $display("TEST PASSED");
    $finish;
  end
